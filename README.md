...
- ✅ **Fase 3 — IA e diplomacia (profunda):** **dois lordes rivais** no mapa (facções vermelha e verde) com **guerra IA-vs-IA**, relações **guerra/trégua/aliança** por lorde (aliança impede ataques mútuos), **demandas com blefe** (agressivo cumpre, cauteloso blefa; você paga ou desmascara), IA com valorização de alvos e consolidação. Save v4.
- ⏭ **Fase 4 (próxima) — Multiplayer assíncrono:** mover a simulação determinística para autoridade no servidor (Node/Laravel no Railway), contas, saves na nuvem e replays a partir do log de comandos + seed.
